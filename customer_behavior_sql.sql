SELECT * FROM customer_shopping_behavior_analysis.customer limit 20;

-- Q1. What is the total revenue generated by male vs. female customers?
SELECT 
    gender, SUM(purchase_amount) AS revenue
FROM
    customer_shopping_behavior_analysis.customer
GROUP BY gender;
...
from customer_shopping_behavior_analysis.customer
)
